...
<title>Spring + WebSocket 例子   qq <%=basePath %>qq  <%=request.getContextPath()%> </title>
...
<body>
	<h1>Spring + WebSocket 例子 <c:url value='/ws'/></h1>
	<ul>
		<li><a href="hello">hello</a> </li>
		<li><a href="message">message</a> </li>
	</ul>
	<p class="new">
		编码: <input type="text" class="code" /> 价格: <input type="text" class="price" />
	...
	测试方式: 提交信息到服务器，服务器会定时发送数据到页面，不管多少个浏览器打开都能接收服务器发送来的信息。
</body>
</html>
